                          ...
                          <div class="card">
                            <div class="card-body">
                              <div class="d-flex justify-content-between">
                                ...
                                <a class="btn btn-success" href="adicionarCliente.php"  style="margin-right: 25px;">Adicionar Cliente</a>
                              </div>
                                  ...
                                  <?php
                                    ...
                                    ?>
                                      <tr>
                                        ...
                                        <td>
                                          <a href="alterarCliente.php?id=<?php echo $cliente->id; ?>" class="btn btn-info">Alterar</a>
                                          <a href="class/controle.php?excluir=<?php echo $cliente->id; ?>"class="btn btn-danger">Excluir</a>
                                        </td>
                                      </tr>
                                    <?php
                                      }
